    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Beleza Master</a>
            </div>
            ...
            <div class="row no-gutter popup-gallery">
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/1.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/1.jpg" class="img-responsive" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/2.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/2.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/3.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/3.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/4.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/4.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/5.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/5.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="view/img/portfolio/fullsize/6.jpg" class="portfolio-box">
                        <img src="view/img/portfolio/thumbnails/6.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Category
