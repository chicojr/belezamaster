...
<br>
<label class="span">Nome do Serviço:</label><br />
 <input  type="text" class="author" name="nome" required="true" maxlength="30" value="${servico.nome}"> <br>
<form:errors path="usuario.nome" cssStyle="color:red; font-size:10px;"  />

<br>

<label class="span"> Valor: </label><br />
 <input   type="text" class="author"  name="valor" required="true" value="${servico.valor}"> <br>
 <form:errors path="servico.valor" cssStyle="color:red; font-size:10px;"  />
 <br>
 
<label class="span">Descrição:</label><br />
 <textarea   type="text" class="author" name="descricao" maxlength="50" required="true" value="${servico.descricao}"></textarea>  <br>
   <form:errors path="servico.descricao" style="width: 300px;" cssStyle="color:red; font-size:10px;"  />
<br>
