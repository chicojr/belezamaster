	...
	<div class="msg"> ${remove}</div>
			...
			<form action="pesquisarProfissional" method="get" >
			   ...
			   <label class="span">Nome:</label><br/>
				<input class="author"type="text" name="nome" />
		...
		<tr style='background-color: #383838; font-weight: bold;'>
				...
				<c:forEach var="profissional" items="${listarProfissional}">
					<tr>
						...
						<td class="span"><a style="color:white" href="removerProfissional?id=${profissional.id}">Remover</a>
							 <td><a style="color:white" href="exibirAlterarProfissional?id=${profissional.id}">Alterar</a></td>
					</tr>
				</c:forEach>
			</table>
		</fieldset>
