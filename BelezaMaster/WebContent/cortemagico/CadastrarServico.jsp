	...
	<div class="contact" id="contact">
		<div class="container">
			<div class="row">
				...
				<div class="m_4">
					<div class="bottom_line_cs"> </div>
				</div>
				<form method="post" action="-">
					<div class="col-md-6 commentform">
						<p class="comment-form-author">
							<label for="author">Nome do serviço</label> 
							<input id="author" name="author" type="text" value="" size="30" maxlength=30 required="required">
						</p>
						
							<p> <label for="author">Descrição</label> 
					             <input id="author"name="author" type="text" value="" size="30" maxlength=50 required="required">
						</p>
						<br>
				
							<label for="author">Valor</label> 
							<input id="author" name="author" type="text" value="" size="30" maxlength=7 required="required">
						</p>
					</div>
